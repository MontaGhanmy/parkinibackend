# Generated by Django 3.0.6 on 2020-06-18 22:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jours_d_ouverture', django.contrib.postgres.fields.ArrayField(base_field=models.BooleanField(default=False), blank=True, default=list, null=True, size=8)),
                ('prix', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True)),
                ...
                ('parking_image', models.ImageField(blank=True, null=True, upload_to='uploads/')),
